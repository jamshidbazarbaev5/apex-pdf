  ...
  return (
    <DocumentSheet>
      ...
      <div className="max-w-[750px] mx-auto space-y-1 mb-12">
        ...
        <Row label="ZIP CODE:" name="driverZipCode" value={String(formData.driverZipCode || '')} onChange={(e) => handleChange('driverZipCode', e.target.value)} />
        <Row label="CELL PHONE:" name="driverCellPhone" value={String(formData.driverCellPhone || '')} onChange={(e) => handleChange('driverCellPhone', e.target.value)} />
        <Row label="EMERGENCY NUMBER/NAME:" name="driverEmergencyNumber" value={String(formData.driverEmergencyNumber || '')} onChange={(e) => handleChange('driverEmergencyNumber', e.target.value)} />
      </div>
