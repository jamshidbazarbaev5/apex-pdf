    ...
    <DocumentSheet className="text-[10px] leading-[1.3] text-black">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-bold mt-2">Protect yourself from suspicious emails or phishing schemes.</p>
          <p className="text-justify">
          ...
          <p className="text-justify mt-2">
            If you receive an unsolicited email claiming to be from the IRS, forward this message to <i>phishing@irs.gov</i>. You may also report misuse of the IRS name, logo, or other IRS property to the Treasury Inspector General for Tax Administration (TIGTA) at 800-366-4484. You can forward suspicious emails to the Federal Trade Commission at <i>spam@uce.gov</i> or report them at <i>www.ftc.gov/complaint</i>. You can contact the FTC at <i>www.ftc.gov/idtheft</i> or 877-IDTHEFT (877-438-4338). If you have been the victim of identity theft, see <i>www.IdentityTheft.gov</i> and Pub. 5027.
          </p>
          <p className="mt-2">
            Go to <i>www.irs.gov/IdentityTheft</i> to learn more about identity theft and how to reduce your risk.
          </p>
        </div>

        {/* Right Column */}
        <div className="flex flex-col gap-2">
          <h2 className="font-bold text-[14px]">Privacy Act Notice</h2>
          <p className="text-justify">
