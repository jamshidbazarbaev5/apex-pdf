...
//               <Checkbox onCheckedChange={(_c) => handleChange('taxClass', 'individual')} />
//               <span>Individual/sole proprietor or single-member LLC</span>
//             </label>
//             <label className="flex items-center gap-1">
//               <Checkbox onCheckedChange={(_c) => handleChange('taxClass', 'ccorp')} />
//               <span>C Corporation</span>
//             </label>
//             <label className="flex items-center gap-1">
//               <Checkbox onCheckedChange={(_c) => handleChange('taxClass', 'scorp')} />
//               <span>S corporation</span>
//             </label>
//             <label className="flex items-center gap-1">
//               <Checkbox onCheckedChange={(_c) => handleChange('taxClass', 'partnership')} />
//               <span>Partnership</span>
//             </label>
//             <label className="flex items-center gap-1">
//               <Checkbox onCheckedChange={(_c:any) => handleChange('taxClass', 'trust')} />
